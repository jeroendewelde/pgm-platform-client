...
export default function createCourse({
  learningLines,
  specialisations,
}: createCourseProps): ReactElement {
  return (
          ...
          >
            {({ values, submitForm, isSubmitting }) => (
              <Form>
                ...
                <p>Voeg Tags toe, de bovenste 5 zijn de belangrijkste tags.</p>
...
export async function getServerSideProps() {
  ...
  const {
    data: data_Specialisations,
    error: error_Specialisations,
    loading: loading_Specialisations,
